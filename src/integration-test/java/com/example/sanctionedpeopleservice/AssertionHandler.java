...
public class AssertionHandler {
  public static void assertPersonNonExistenceError(String personName, ApiError error) {
    ...
    assertEquals("Person: ".concat(personName).concat(" does not exist in sanctioned people list!"),
